...
maleUrl = "http://www.dcrussia.ru/skidki-men/"
femaleUrl = "http://www.dcrussia.ru/skidki-women/"
childrensUrl = "http://www.dcrussia.ru/skidki-kids/"
...
def getDCLoadedResults(type):
    if type == 'woman':
        return getThings(femaleUrl)
    elif type == 'men':
        return getThings(maleUrl)
    elif type == 'kids':
